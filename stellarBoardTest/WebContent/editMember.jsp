...
<jsp:useBean id="vo" class=model.member.MemberVO"  scope="session"/>
	...
	<div id="wrapper">
		...
		<nav id="nav">
			<ul>
				...
				<li><a href="reg.jsp"  class="active">회원가입하기</a></li>
		...
		<div id="main">
			...
			<section id="intro" class="main">
				<form method="post" action="ctrl.jsp" name="form1"> <!-- 미구현 -->
					...
					<div class="table-wrapper">
						<table>
							...
							<tbody>
								...
								<tr>
									<td>이름</td>
									<td><input type="text" name="userName" required value="<%=vo.getUserName() %>"
										placeholder="변경할 이름을 입력하세요"></td>
								</tr>
							</tbody>
							<tfoot>
								<tr>									
									<td colspan="2" align="right"><input type="submit" value="회원정보 변경하기">
									<input type="button" value="회원탈퇴" onClick="del()"></td><!-- 미구현 -->
								</tr>
								
							</tfoot>
						</table>
						<a href="ctrl.jsp?action=list" class="button primary">게시판으로가기</a>
					</div>
				</form>
			</section>
		</div>
